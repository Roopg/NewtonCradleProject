...
//to lift the first bob. applyForce(body,poistion,force(x &y directions-pushes left and up))
function keyPressed() {
  	if (keyCode === UP_ARROW) {
...
//the function below not required for phase 1-no impact if left out
